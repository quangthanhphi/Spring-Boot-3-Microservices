package com.spring.microservice.api_gateway.route;
...
public class Routes {
    ...
    // using filter :http://localhost:8080/aggregate/product-service/v3/api-docs -> http://localhost:8080/api-docs
    ...
    public RouterFunction<ServerResponse> fallBackRoute() {
        return route("fallbackRoute")
                .GET("/fallbackRoute", request -> ServerResponse.status(HttpStatus.SERVICE_UNAVAILABLE).body("Service unavailable, try again"))
                .build();
    }
}
